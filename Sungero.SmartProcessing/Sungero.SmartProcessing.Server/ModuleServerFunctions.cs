  ...
  public class ModuleFunctions
  {
    ...
    public virtual IDocumentPackage PrepareDocumentPackage(IBlobPackage blobPackage, IArioPackage arioPackage)
    {
      ...
      foreach (var arioDocument in arioPackage.Documents)
      {
        ...
        {
          using (var bodyFromArio = this.GetDocumentBody(arioUrl, arioDocument.BodyGuid))
          {
    ...
    [Public]
    public virtual System.IO.Stream GetDocumentBody(string arioUrl, string documentGuid)
    {
    ...
    public virtual void LinkDocuments(IDocumentPackage package)
    {
      ...
      var addendums = package.DocumentInfos
    ...
    public virtual void RenameDocuments(IDocumentPackage package)
    {
      ...
      var addendums = package.DocumentInfos.Where(i => !i.IsLeadingDocument && !i.FoundByBarcode).Select(d => d.Document);
      foreach (var addendum in addendums)
      {
