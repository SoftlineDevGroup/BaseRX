...
namespace Sungero.Shell.Server
{
  public class ModuleFunctions
  {
    ...
    /// <summary>
    /// Текущий пользователь руководитель департамента.
    /// </summary>
    ...
    // Remote для того, чтобы в клиентском обработчике выдернуть исполнителя заданий.
    [Remote(IsPure = true)]
    ...
    /// <param name="periodBegin">Начало периода.</param>
    /// <param name="periodEnd">Конец периода.</param>
    /// <returns>Количество созданных заадч по датам.</returns>
    ...
    public static Sungero.Core.Color GetAssignmentComplrtionWidgetValueColor(int value)
    {
      if (value <= 50)
    ...
    /// <returns>Исполнительская дисциплина по сотрудникам с уникальными именами, отсортированые по возрастанию значения исп. дисциплины.</returns>
    ...
    /// <returns>Загруженные подразделения с уникальными именами, отсортированые по возрастанию значения исп. дисциплины.</returns>
