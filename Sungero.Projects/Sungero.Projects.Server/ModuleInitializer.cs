...
namespace Sungero.Projects.Server
{
  public partial class ModuleInitializer
  {
    ...
    public static void CreateApprovalRule(string name, List<Enumeration> stages)
    {
      ...
      // Заменяем созданный по умолчанию этап согласования с обязательными согласующими созданным/наиденным ранее этапом.
    ...
    public static void CreateProjectFolder()
    {
      ...
      {
        InitializationLogger.Debug("Init: Create default projects arhive folder.");
