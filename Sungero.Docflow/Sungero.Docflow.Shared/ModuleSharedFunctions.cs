...
namespace Sungero.Docflow.Shared
{
  public class ModuleFunctions
  {
    ...
    /// <summary>
    /// Получить список поручений для формирования резолюции.
    /// </summary>
    ...
    /// <param name="genetiveName">Имя в родительном падеже.</param>
    ...
    public static string GetNumberDeclination(int number,
                                              ...
                                              CommonLibrary.LocalizedString genetiveName,
    ...
    /// <returns>Название таблички, вида "Sungero_Reports_{reportName}_{userId}_{randomNumber}".</returns>
    [Public]
    ...
    /// <param name="report">Отчёт.</param>
    /// <param name="userId">ID пользователя, запустившего отчёт.</param>
    /// <param name="postfix">Постфикс таблички.</param>
    /// <returns>Название таблички, вида "Sungero_Reports_{reportName}_{userId}_{postfix}".</returns>
    [Public]
    ...
    #region TrimSpecialSymbols, TrimQoutes
    ...
    /// </summary>
    /// <param name="task">Задача.</param>
    /// <returns>Сообщения валидации, если автор не является сотрудником, иначе пустая строка.</returns>
    [Public]
