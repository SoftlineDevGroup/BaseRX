...
namespace Sungero.Docflow.Server
{
  ...
  partial class ApprovalStageFunctions
  {
    ...
    /// <summary>
    /// Получить список правил, в которых не может быть использованы выбранные роли.
    /// </summary>
    ...
    public List<IApprovalRuleBase> GetRulesWithImpossibleRoles()
    {
      ...
      if (roles.Any())
      {
        ...
        // Проверка ответственого за договор и руководителя ответственного за договор.
