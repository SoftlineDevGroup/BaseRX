  ...
  partial class AssignmentCompletionReportServerHandlers
  {
    ...
    public override void BeforeExecute(Sungero.Reporting.Server.BeforeExecuteEventArgs e)
    {
      ...
      if (AssignmentCompletionReport.BusinessUnit != null)
        AssignmentCompletionReport.ParamsDescription += string.Format(Docflow.Resources.ReportBusinessUnit, AssignmentCompletionReport.BusinessUnit.Name, Environment.NewLine);
      
      if (AssignmentCompletionReport.Department != null)
        AssignmentCompletionReport.ParamsDescription += string.Format(Docflow.Resources.ReportDepartment, AssignmentCompletionReport.Department.Name, Environment.NewLine);
      
      AssignmentCompletionReport.ParamsDescription += string.Format(Docflow.Resources.ReportOldAssignments,
                                                                    AssignmentCompletionReport.LoadOldAssignments == true ? Docflow.Resources.ReportYes : Docflow.Resources.ReportNo, Environment.NewLine);
