...
namespace Sungero.FinancialArchive.Server
{
  public class ModuleFunctions
  {
    ...
    /// <param name="cuuid">Uuid КА.</param>
    /// <param name="ctin">ИНН КА.</param>
    /// <param name="ctrrc">КПП КА.</param>
    ...
    /// <param name="isAdjustment">Корректирочный (важно только для УКД).</param>
    ...
    /// <summary>
    /// Выгрузить подписи документа.
    /// </summary>
    /// <param name="document">Документ.</param>
    /// <param name="version">Версия документа.</param>
    /// <returns>Возможность выгрузить подписи документов.</returns>
    [Public]
    public virtual bool CanExportWithSignatures(IOfficialDocument document, Sungero.Content.IElectronicDocumentVersions version)
    {
