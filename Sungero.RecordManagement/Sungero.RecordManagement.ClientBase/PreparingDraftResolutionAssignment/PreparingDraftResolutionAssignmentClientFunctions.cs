...
namespace Sungero.RecordManagement.Client
{
  partial class PreparingDraftResolutionAssignmentFunctions
  {
    ...
    {
      var isActionItems = _obj.ResolutionGroup.All.Count != 0;
      var dialogText = isActionItems ? PreparingDraftResolutionAssignments.Resources.SendForReviewWithResolution :
