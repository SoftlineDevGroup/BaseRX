...
namespace Sungero.Contracts
{
  ...
  partial class IncomingInvoiceFilteringServerHandler<T>
  {
    ...
    public override IQueryable<T> Filtering(IQueryable<T> query, Sungero.Domain.FilteringEventArgs e)
    {
      ...
      {
        query = query.Where(x => (_filter.Draft && x.LifeCycleState == ContractBase.LifeCycleState.Draft && x.InternalApprovalState == null) ||
                            (_filter.OnApproval && x.LifeCycleState != ContractBase.LifeCycleState.Obsolete &&
                            ...
                            (_filter.PayAccepted && x.LifeCycleState == ContractBase.LifeCycleState.Active) ||
                            (_filter.PayRejected && x.LifeCycleState == ContractBase.LifeCycleState.Obsolete));
      }
