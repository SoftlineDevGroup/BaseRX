...
namespace Sungero.Contracts.Shared
{
  partial class IncomingInvoiceFunctions
  {
    ...
    /// </summary>
    /// <param name="incommingInvoice">Счет для проверки.</param>
    ...
    public static bool HaveDuplicates(IIncomingInvoice incommingInvoice,
                                      ...
                                      Parties.ICounterparty counterparty)
    {
      ...
      return Functions.IncomingInvoice.Remote.GetDuplicates(incommingInvoice, documentKind, number, (DateTime)date, (double)totalAmmount, currency, counterparty).Any();
    }
  }
}